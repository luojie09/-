...
internal object HomeTypographyScale {
    ...
    val DaysValue = HomeTextToken(52.sp, 52.sp, SecretBaseDesignTokens.FontWeights.Display, SecretBaseSansFontFamily, letterSpacing = (-1.1).sp)
    val DaysUnit = HomeTextToken(18.sp, 22.sp, SecretBaseDesignTokens.FontWeights.Title, SecretBaseSansFontFamily, letterSpacing = (-0.05).sp)
    val Meta = HomeTextToken(14.sp, 20.sp, SecretBaseDesignTokens.FontWeights.Body, SecretBaseSansFontFamily)
