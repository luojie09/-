...
internal object HomeTypographyScale {
    ...
    val HeroName = HomeTextToken(32.sp, 36.sp, FontWeight.SemiBold, SecretBaseSerifFontFamily, letterSpacing = (-0.4).sp)
    ...
    val DaysValue = HomeTextToken(52.sp, 52.sp, FontWeight.SemiBold, SecretBaseSansFontFamily, letterSpacing = (-1.1).sp)
    ...
    val AnniversaryTitle = HomeTextToken(17.sp, 22.sp, FontWeight.SemiBold, SecretBaseSerifFontFamily, letterSpacing = (-0.15).sp)
    val Capsule = HomeTextToken(12.sp, 16.sp, FontWeight.SemiBold)
    val SectionTitle = HomeTextToken(22.sp, 28.sp, FontWeight.Bold, SecretBaseSerifFontFamily, letterSpacing = (-0.25).sp)
    val SectionAction = HomeTextToken(13.sp, 18.sp, FontWeight.Medium)
    val FeatureTitle = HomeTextToken(17.sp, 22.sp, FontWeight.SemiBold, SecretBaseSerifFontFamily, letterSpacing = (-0.15).sp)
    val FeatureSummary = HomeTextToken(14.sp, 20.sp, FontWeight.Medium)
    val ActivityTitle = HomeTextToken(16.sp, 22.sp, FontWeight.SemiBold, SecretBaseSerifFontFamily, letterSpacing = (-0.1).sp)
    ...
    val PickerTitle = HomeTextToken(22.sp, 28.sp, FontWeight.SemiBold, SecretBaseSerifFontFamily, letterSpacing = (-0.25).sp)
}
